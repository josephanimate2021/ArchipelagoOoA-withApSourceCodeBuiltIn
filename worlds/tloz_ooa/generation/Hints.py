# TODO: Correct all owls for ages since most of these are from Seasons and they don't link up to ages at all.
...
def create_region_hints(world) -> list[tuple[str, str | int]]:
...
def create_item_hints(world) -> list[Item | None]:
