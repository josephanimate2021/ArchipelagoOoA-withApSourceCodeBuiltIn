...
def make_d2_logic():
    return [
        ...
        ["d2 arrow room", "d2 rupee room", False, oo_can_remove_rockslide(False)],
        ...
        ["d2 alt entrances", "d2 scrub", False, oo_has_rupees_for_shop("d2Scrub")],

        # 2 keys
        ["d2 roller chest", "d2 spinner", False, And(
            oo_has_small_keys(2, 2),
            oo_can_kill_facade()
        )],
        ...
        # 3 keys
        ["d2 arrow room", "d2 hardhat room", False, oo_has_small_keys(2, 3)],
        ...
        ["d2 spinner", "d2 terrace chest", False, oo_has_small_keys(2, 3)],
    ]
...
def make_d3_logic():
    return [
        ...
        ["d3 mimic stairs", "d3 bombed wall chest", False, oo_can_remove_rockslide(False)],

        # 2 keys
        ["d3 water room", "d3 mimic chest", False, And(
            Or(
                oo_has_small_keys(3, 2),
        ...
        ["d3 omuai stairs", "d3 boss", False, oo_has_boss_key(3)],
    ]
...
def make_d4_logic():
    return [
        ...
        ["d4 terrace", "d4 scrub", False, oo_has_rupees_for_shop("d4Scrub")],
        ...
        ["enter gohma", "d4 boss", False, Or(
            And(
                ...
                Or(
                    oos_has_seed_thrower(),
                    oo_option_hard_logic()  # You can kill Gohma with the satchel. Yup...
                ),
                Or(
                    oo_has_scent_seeds(),
                    oo_has_ember_seeds()
            ...
            And(
                ...
                Or(
                    ...
                    And(
                        oo_option_medium_logic(),
                        oo_has_satchel(2),  # It may require quite a bunch of mystery seeds...
                        oos_can_use_mystery_seeds()
                    )
                )
            )
...
def make_d5_logic():
    return [
        ...
        ["d5 cart bay", "d5 terrace chest", False, And(
            oos_has_feather(),
            oo_can_remove_rockslide(False)  # Bombchus can be thrown from the middle platform
        )],
...
def make_d6_logic():
    return [
        ...
        ["d6 1F east", "d6 rupee room", False, oo_can_remove_rockslide(False)],

        ["d6 1F east", "d6 1F terrace", False, None],
        ["enter d6", "d6 1F terrace", False, And(
            oo_has_small_keys(6, 2),
            Or(
                oos_has_magnet_gloves(),
                oo_has_cane()
            )
        ...
        # 3 keys
        ["enter d6", "d6 beamos room", False, oo_has_small_keys(6, 3)],
        ["d6 beamos room", "d6 2F gibdo chest", False, None],
        ["d6 beamos room", "d6 2F armos chest", False, oo_can_remove_rockslide(False)],
        ...
        ["enter d6", "d6 spinner north", False, And(
            ...
            Or(
                oo_option_medium_logic(),  # Iframes through the spikes
                oos_has_feather()
            ),
            Or(
                And(
                    oo_has_small_keys(6, 1),
...
def make_d7_logic():
    return [
        ...
        ["d7 pot room", "d7 magunesu chest", False, oo_has_cane()],
        ...
        ["enter poe B", "d7 water stairs", False, oo_has_flippers()],
        ...
        ["d7 water stairs", "d7 past darknut bridge", False, Or(
            ...
            oos_can_jump_4_wide_pit(),
            oo_has_tight_switch_hook(),  # or hook to the other side
            ...
            And(
                ...
                Or(
                    oos_can_kill_armored_enemy(True, True),
                    oo_has_shield(),  # To push the darknut, the rod not really working
        ...
        ["d7 water stairs", "d7 maze chest", False, And(
            ...
            Or(
                ...
                And(
                    Or(
                        oo_option_medium_logic() & oos_can_kill_moldorm(True),
                        oos_can_kill_moldorm()
                    ),
                    Or(
                        # Kill poe sisters
...
def make_d8_logic():
    return [
        ...
        ["d8 hardhat room", "d8 hardhat drop", False, Or(
            And(
                oo_can_remove_rockslide(False),  # For the bombchus, leave the hardhat stuck in the upper line to guide the bombchus
                oos_has_magnet_gloves()
            ),
        ...
        # 2 keys
        ["d8 spike room", "d8 spinner", False, oo_has_small_keys(8, 2)],
        ...
        ["frypolar entrance", "frypolar room", False, oo_has_small_keys(8, 3)],
        ...
        # 4 keys
        ["d8 ice puzzle room", "d8 crystal room", False, oo_has_small_keys(8, 4)],
        ["d8 crystal room", "magical ice owl", False, oos_can_use_mystery_seeds()],
        ["d8 crystal room", "d8 ghost armos drop", False, oo_can_remove_rockslide(False)],
...
def make_d11_logic(options: OracleOfSeasonsOptions):
    ...
    logic = [
        ...
        ["d11 floor 2 keydrop", "d11 floor 2 chest", False, oo_has_small_keys(11)],
