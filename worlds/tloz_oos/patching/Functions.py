...
from ..common.patching.Functions import *
...
def define_option_constants(assembler: Z80Assembler, patch_data):
    ...
    define_common_option_constants(assembler, patch_data)
...
def define_tree_sprites(assembler: Z80Assembler, patch_data):
    define_tree_sprites_common(assembler, patch_data, {  # Name: (map, position)
